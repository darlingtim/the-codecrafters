# CODECRAFTERS — HACKATHON CHALLENGE THE CLI CALCULATOR

  ## Rules:
  - → Write everything in Go. Standard library only.
  - → Must compile and run without errors.
  - → Push to your the-codecrafters repo in a folder named: thecodecrafterthon-day1/
...
###  OPERATIONS
  The user types an expression. The calculator responds with the result.  
  Support:  
  ```
     add <a> <b>   → addition  
     sub <a> <b>   → subtraction  
